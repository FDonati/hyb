"""
Django settings for hyb project.
...
SECRET_KEY_FILE = open(os.path.join(BASE_DIR, 'SECRET_KEY.txt')).readlines()
SECRET_KEY = SECRET_KEY_FILE[0]
...
WSGI_APPLICATION = 'hyb.wsgi.application'
